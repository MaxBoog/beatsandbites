  ...
  const features = [
    {
      ...
      description:
        "Using Beats & Bites users can select their mood: lazy, moderate, or chef-like—along with available ingredients, and the app will recommend recipes that match their preferences while also suggesting a matching playlist to listen to while cooking and dining",
